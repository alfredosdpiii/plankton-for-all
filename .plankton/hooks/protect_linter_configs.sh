...
# The canonical hook test suite is intentionally editable.
is_hook_test_path() {
  local p="$1"
...
# Default protects project Plankton state and Pi extension files.
PLANKTON_PROTECTED_DIRS="${PLANKTON_PROTECTED_DIRS:-.plankton:.pi}"
